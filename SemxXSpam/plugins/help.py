...
HELP_PIC = "https://telegra.ph/file/1d54ee012bf70c3e37430.jpg"
...
async def helpback(event):
   if event.query.user_id in SUDO_USERS:    
      await event.edit(
        ...
        Alert = (
                "Noob !! Make Your Own STAR BOY X Spam Bots !! @TEAM_HEARTLESS_POLICE_ONLINE"
            )
